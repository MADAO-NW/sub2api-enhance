...
func (r *Repository) Stats(ctx context.Context, q StatsQuery) (*Stats, error) {
 ...
 (SELECT count(*) FROM sub2api_enhance.third_party_prompt_audit_jobs j WHERE j.run_kind='request' AND j.created_at>=$1 AND j.created_at<$2 AND ($3='' OR j.execution_mode=$3)),
